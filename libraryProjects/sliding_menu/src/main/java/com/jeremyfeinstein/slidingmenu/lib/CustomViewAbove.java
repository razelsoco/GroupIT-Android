...
public class CustomViewAbove extends ViewGroup {
	...
	public interface OnPageChangeListener {
         ...
         *
         * @param position Position index of the page to be selected.
	     * @return whether the page should be selected
	     */
	...
	void setCurrentItemInternal(int item, boolean smoothScroll, boolean always, int velocity) {
		...
		if (dispatchSelected && mOnPageChangeListener != null && !mOnPageChangeListener.onPageSelect(item) && mVelocityTracker !=null) {
		    setCurrentItemInternal(mCurItem, true, true, (int) VelocityTrackerCompat.getXVelocity(
	...
	public void drawFade(Canvas canvas, float openPercent) {
		...
		int left = 0;
		int right = 0;
		int mMode = mViewBehind.getMode();
		if (mMode == SlidingMenu.LEFT) {
			left = mContent.getLeft();
			right = getRight();
